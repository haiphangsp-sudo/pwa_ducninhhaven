...
export function renderDrawer() {
  ...
  const labelNumber = total > 1 ? translate("cart_bar.items"): translate("cart_bar.item");
  ...
  drawer.querySelector(".drawer__header-count").textContent = totalQuantity + " " + labelNumber;
